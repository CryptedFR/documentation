...
| `statusCode`     | `400`          | Code HTTP de la réponse. |
| `code`     | `E_INVALID_CREDENTIALS`        | Code erreur qui permet d'identifier l'erreur                |
| `message`     | `Invalid user credentials`        | Message de l'erreur     |
